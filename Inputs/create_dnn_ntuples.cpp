...
void create_dnn_ntuples( TString era = "2017" ){
  ...
  if (era == "2018"){
     ...
     IsEra2018 = 1;
     TFile *f= new TFile("/nfs/dust/cms/user/mameyer/SM_HiggsTauTau/HTauTau_emu/QCDEstimation/output_2018_withuncertainties_v2/QCDweights.root","READ");
    ...
    IsEra2017 = 1;
    TFile *f= new TFile("/nfs/dust/cms/user/mameyer/SM_HiggsTauTau/HTauTau_emu/QCDEstimation/output_2017_withuncertainties_v2/QCDweights.root","READ");
    hNonClosureCorrection=(TH2F*)f->Get("NonClosureCorrection");
    hIsolationCorrection=(TH2F*)f->Get("IsolationCorrection");
    hOS_SS_transfer_factors_njetgt1=(TF1*)f->Get("OS_SS_transfer_factors_njetgt1");
    hOS_SS_transfer_factors_njet1=(TF1*)f->Get("OS_SS_transfer_factors_njet1");
    ...
    IsEra2016 = 1;
    TFile *f= new TFile("/nfs/dust/cms/user/mameyer/SM_HiggsTauTau/HTauTau_emu/QCDEstimation/output_2016_withuncertainties_v2/QCDweights.root","READ");
    hNonClosureCorrection=(TH2F*)f->Get("NonClosureCorrection");
    hIsolationCorrection=(TH2F*)f->Get("IsolationCorrection");
    hOS_SS_transfer_factors_njetgt1=(TF1*)f->Get("OS_SS_transfer_factors_njetgt1");
    hOS_SS_transfer_factors_njet1=(TF1*)f->Get("OS_SS_transfer_factors_njet1");
