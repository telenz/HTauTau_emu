...
#combine -M AsymptoticLimits --X-rtd MINIMIZER_analytic --cminDefaultMinimizerStrategy 0 --significance -m 125 -n $ERA output/${ERA}_smhtt/cmb/125/${ERA}_workspace.root
