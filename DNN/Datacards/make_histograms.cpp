...
void make_histograms(TString config_name="config_for_gof_2016.cfg") {
  ...
  const bool no_dnn_uncertainties      = cfg.get<bool>("no_dnn_uncertainties");
  ...
  for(auto& cat : category_map){
    for(auto & smpl : cat.second.sample_list){
      ...
      // 2.) TT contamination in embedded sample  (only initialize this uncertainty -> calculate it later)
	...
	smpl.second = create_systematic_uncertainty("btagDown", "_CMS_htt_eff_b_Run" +era+ "Down", cat.second.plot_2d, smpl.second, tree_, true, "btagDown");
      ...
      if(no_dnn_uncertainties) continue;

      // 7.) Electron scale (applied on both embedded and mc), not applied for now
      ...
      // 8.) Electron scale (applied only on embedded)
      if(smpl.second.name == "EMB"){
	...
	smpl.second.uncertainties["escale_emb_Down"].filename.ReplaceAll("NOMINAL","_escaleDown");
      ...
      // 9.) Electron scale and resolution (applied only on MC)
      if(smpl.second.name != "EMB"){
   ...
   smpl.second.uncertainties["ereso_mc_Up"].filename.ReplaceAll("NOMINAL","_eresoUp");
	smpl.second.uncertainties["ereso_mc_Down"].filename.ReplaceAll("NOMINAL","_eresoDown");
      }
      ...
      smpl.second.uncertainties["jecUncRelativeSampleYearUp"].filename.ReplaceAll("NOMINAL","_jecUncRelativeSampleYearUp");
      smpl.second.uncertainties["jecUncRelativeSampleYearDown"].filename.ReplaceAll("NOMINAL","_jecUncRelativeSampleYearDown");
      ...
      smpl.second.uncertainties["jecUncAbsoluteYearUp"].filename.ReplaceAll("NOMINAL","_jecUncAbsoluteYearUp");
      smpl.second.uncertainties["jecUncAbsoluteYearDown"].filename.ReplaceAll("NOMINAL","_jecUncAbsoluteYearDown");
      ...
      smpl.second.uncertainties["jecUncBBEC1YearUp"].filename.ReplaceAll("NOMINAL","_jecUncBBEC1YearUp");
      smpl.second.uncertainties["jecUncBBEC1YearDown"].filename.ReplaceAll("NOMINAL","_jecUncBBEC1YearDown");
      ...
      smpl.second.uncertainties["jecUncHFYearUp"].filename.ReplaceAll("NOMINAL","_jecUncHFYearUp");
      smpl.second.uncertainties["jecUncHFYearDown"].filename.ReplaceAll("NOMINAL","_jecUncHFYearDown");
      ...
      smpl.second.uncertainties["jecUncEC2YearUp"].filename.ReplaceAll("NOMINAL","_jecUncEC2YearUp");
      smpl.second.uncertainties["jecUncEC2YearDown"].filename.ReplaceAll("NOMINAL","_jecUncEC2YearDown");
      ...
      smpl.second.uncertainties["jecUncEC2Up"].filename.ReplaceAll("NOMINAL","_jecUncEC2Up");
      smpl.second.uncertainties["jecUncEC2Down"].filename.ReplaceAll("NOMINAL","_jecUncEC2Down");
      ...
      smpl.second.uncertainties["jecUncFlavorQCDUp"].filename.ReplaceAll("NOMINAL","_jecUncFlavorQCDUp");
      smpl.second.uncertainties["jecUncFlavorQCDDown"].filename.ReplaceAll("NOMINAL","_jecUncFlavorQCDDown");

      if(smpl.second.name == "ZTT" || smpl.second.name == "ZL" || smpl.second.name == "W" || smpl.second.name.Contains("125")){
	// 12.) Recoil scale/resolution uncertainties
	...
	// 13.) Unclustered MET scale (FIXME : is this really the correct way to estimate it?)
